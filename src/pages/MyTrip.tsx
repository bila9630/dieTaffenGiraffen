      ...
      <div className="mx-auto max-w-7xl pt-20">
        ...
        <div className="space-y-6">
          {trips.map((trip) => (
            <Card
              key={trip.id}
              className="bg-card/70 backdrop-blur-xl border-glass-border hover:border-primary/50 transition-colors"
            >
              <CardHeader>
        ...
        {trips.length === 0 && (
          <Card className="bg-card/70 backdrop-blur-xl border-glass-border">
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center">No trips yet. Start planning your next adventure!</p>
            </CardContent>
          </Card>
        )}
      </div>
